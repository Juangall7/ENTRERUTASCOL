...
export const municipalities: Municipality[] = [
  ...
  { id: '30', name: 'Puerto Santander', slug: 'puerto-santander', description: 'Puerto comercial y fronterizo clave con Venezuela.', history: '', image: 'https://picsum.photos/seed/ps30/800/600', culture: [], spots: [], products: [], corregimientos: [] },
